# Es el festival de los juegos RPG.  Crea un programa que muestre por pantalla el nombre y el precio final de todos los juegos suponiendo un IVA del 21% y teniendo SOLO los juegos cuyo género sea RPG un descuento del 25%.
...
for v in lista_juegos:
    print(f"{v.nombre}, precio: {v.precio_final(0.21, 0)}")